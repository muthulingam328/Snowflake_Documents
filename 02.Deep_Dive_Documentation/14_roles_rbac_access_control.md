...
![Roles, RBAC & Access Control](14_roles_rbac_access_control.png)

## Introduction

Snowflake uses role-based access control. Privileges are granted to
roles, roles can be arranged in hierarchies, and users receive roles
...
-   **System roles:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **Custom roles:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **Role hierarchy:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **Privileges and grants:** Understand the purpose, behavior, and
    practical importance of this concept.
-   **Future grants:** Understand the purpose, behavior, and practical
    importance of this concept.
...
Roles, RBAC & Access Control is an important part of a complete
