...
![Snowpark with Python](17_snowpark_with_python.png)

## Introduction

Snowpark allows developers to process Snowflake data using Python APIs
while pushing execution into Snowflake. DataFrames, UDFs, stored
procedures, and machine learning workflows can be developed close to the
data.
...
-   **Snowpark Session:** Understand the purpose, behavior, and
    practical importance of this concept.
-   **DataFrames:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **Transformations:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **UDFs:** Understand the purpose, behavior, and practical importance
    of this concept.
-   **Stored procedures:** Understand the purpose, behavior, and
    practical importance of this concept.
...
**Python Code → Snowpark API → Snowflake Execution**
...
Snowpark with Python is an important part of a complete Snowflake
