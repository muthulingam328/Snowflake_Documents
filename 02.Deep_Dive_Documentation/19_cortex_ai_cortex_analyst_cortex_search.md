...
![Cortex AI, Cortex Analyst & Cortex
Search](19_cortex_ai_cortex_analyst_cortex_search.png)

## Introduction

Snowflake Cortex provides AI capabilities close to governed enterprise
data. Cortex AI functions support language tasks, Cortex Analyst enables
natural-language analytics over semantic models or views, and Cortex
Search supports retrieval experiences.
...
-   **AI functions:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **Natural-language analytics:** Understand the purpose, behavior,
    and practical importance of this concept.
-   **Semantic layer:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **Cortex Search:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **RAG use cases:** Understand the purpose, behavior, and practical
    importance of this concept.
...
**Enterprise Data → Cortex AI / Analyst / Search → AI Application**
...
Cortex AI, Cortex Analyst & Cortex Search is an important part of a
