...
![Data Loading and Unloading](05_data_loading_and_unloading.png)

## Introduction

Snowflake supports bulk and continuous data ingestion. Data can be
loaded from local systems or cloud object storage and unloaded to stages
for downstream processing, exchange, or archival.
...
-   **Bulk loading:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **Continuous loading:** Understand the purpose, behavior, and
    practical importance of this concept.
-   **COPY INTO table:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **COPY INTO location:** Understand the purpose, behavior, and
    practical importance of this concept.
-   **Load validation:** Understand the purpose, behavior, and practical
    importance of this concept.
...
**Files → Stage → COPY INTO → Snowflake Table**
...
Data Loading and Unloading is an important part of a complete Snowflake
