...
![dbt with Snowflake](18_dbt_with_snowflake.png)

## Introduction

dbt organizes SQL transformations as modular models with dependency
management, testing, documentation, and deployment workflows. Snowflake
provides the scalable execution platform for these transformations.
...
-   **Project structure:** Understand the purpose, behavior, and
    practical importance of this concept.
-   **Sources and models:** Understand the purpose, behavior, and
    practical importance of this concept.
-   **Materializations:** Understand the purpose, behavior, and
    practical importance of this concept.
-   **Tests:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **Documentation:** Understand the purpose, behavior, and practical
    importance of this concept.
...
**Sources → dbt Models → Tests → Snowflake Data Marts**
...
dbt with Snowflake is an important part of a complete Snowflake learning
