...
![Semi-Structured Data](07_semi_structured_data.png)

## Introduction

Snowflake natively supports semi-structured data through VARIANT,
OBJECT, and ARRAY types. JSON, Parquet, and XML content can be queried
with path expressions and expanded into rows using FLATTEN.
...
-   **VARIANT:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **OBJECT:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **ARRAY:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **Path expressions:** Understand the purpose, behavior, and
    practical importance of this concept.
-   **FLATTEN:** Understand the purpose, behavior, and practical
    importance of this concept.
...
**JSON / Parquet / XML → VARIANT → FLATTEN → Analytics**
...
Semi-Structured Data is an important part of a complete Snowflake
