...
![Snowpipe & Snowpipe Streaming](12_snowpipe_snowpipe_streaming.png)

## Introduction

Snowpipe supports continuous file ingestion using event notifications,
while Snowpipe Streaming is designed for lower-latency row-based
ingestion. Both reduce the need for manually scheduled bulk loads.
...
-   **Continuous ingestion:** Understand the purpose, behavior, and
    practical importance of this concept.
-   **AUTO_INGEST:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **Event notifications:** Understand the purpose, behavior, and
    practical importance of this concept.
-   **Pipe monitoring:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **Streaming ingestion:** Understand the purpose, behavior, and
    practical importance of this concept.
...
**Cloud Storage / App → Snowpipe → Snowflake Table**
...
Snowpipe & Snowpipe Streaming is an important part of a complete
