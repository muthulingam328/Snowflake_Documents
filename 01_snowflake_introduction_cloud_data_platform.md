...
![Snowflake Introduction & Cloud Data
Platform](01_snowflake_introduction_cloud_data_platform.png)

## Introduction

Snowflake is a cloud-native data platform designed for analytics, data
engineering, application development, data sharing, and AI workloads.
Its main advantage is the separation of storage and compute, allowing
teams to scale processing independently from stored data.
...
-   **Cloud-native platform:** Understand the purpose, behavior, and
    practical importance of this concept.
-   **Independent storage and compute:** Understand the purpose,
    behavior, and practical importance of this concept.
-   **Elastic scaling:** Understand the purpose, behavior, and practical
    importance of this concept.
-   **Secure data collaboration:** Understand the purpose, behavior, and
    practical importance of this concept.
-   **Multi-cloud availability:** Understand the purpose, behavior, and
    practical importance of this concept.
...
**Source Systems → Snowflake Platform → Analytics / AI / Applications**
...
Snowflake Introduction & Cloud Data Platform is an important part of a
